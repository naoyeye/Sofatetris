...
* @Last Modified time: 2015-05-02 15:58:33
*/
...
var app = new p2.WebGLRenderer(function () {
    ...
    var dogBodyShape = new p2.Capsule(1.4, 0.4);
    var dogLegShape = new p2.Capsule(1, 0.2);
    var dogHeadShape = new p2.Circle(0.5);
    var dogArmShape = new p2.Capsule(1, 0.2);

    // 头部
    var dogHeadWrap = new p2.Body({
        mass: 1,
        position : [-1, 0],
        angularVelocity: 1
    });
    ...
    // 身体
    var dogBodyWrap = new p2.Body({
        mass: 1,
        position : [0, 0]
    });

    // 腿
    var dogLegWrap = new p2.Body({
        mass: 1,
        position : [1, 0],
        angle: -1
    });
    ...
    // 胳膊
    var dogArmWrap = new p2.Body({
        mass: 1,
        position : [0, 0],
        angle: 1
    });

    dogHeadWrap.addShape(dogHeadShape);
    dogBodyWrap.addShape(dogBodyShape);
    dogLegWrap.addShape(dogLegShape);
    dogArmWrap.addShape(dogArmShape);


    world.addBody(dogHeadWrap);
    world.addBody(dogBodyWrap);
    world.addBody(dogLegWrap);
    world.addBody(dogArmWrap);

    // 弹性伸缩
    var rotationalSpring = new p2.RotationalSpring(dogBodyWrap, dogLegWrap, dogHeadWrap, dogArmWrap, {
        stiffness : 10,
        damping: 0.01
    });
    ...
    // 部位连接 回旋限制
    // 腿与身体
    var revoluteA = new p2.RevoluteConstraint(dogBodyWrap, dogLegWrap, {
        localPivotA: [0.6, 0],
        localPivotB: [-1, 0],
    ...
    // 头部与身体
    var revoluteB = new p2.RevoluteConstraint(dogBodyWrap, dogHeadWrap, {
        localPivotA: [-1.3, 0],
        localPivotB: [0.2, 0],
        collideConnected: false
    });
    ...
    // 胳膊于身体
    var revoluteC = new p2.RevoluteConstraint(dogBodyWrap, dogArmWrap, {
        localPivotA: [-0.6, 0],
        localPivotB: [1, 0],
        collideConnected: false
    });
    world.addConstraint(revoluteC);
...
//     N = 3,         // Number of circles in x direction
//     M = 3,         // and in y
//     r = 1,       // circle radius
